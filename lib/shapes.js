...
class Circle extends Shape { 
    constructor(shapeColourChoice, text, textColourChoice) {
        super(shapeColourChoice, text, textColourChoice);
    };
    render() {
        return  `
        <svg version="1.1"
            ...
            <circle cx="150" cy="100" r="100" fill="${this.shapeColourChoice}" />
            <text x="150" y="125" font-size="70" text-anchor="middle" fill="${this.textColourChoice}">${this.text}</text>
        </svg>
        `
    };
};
...
class Square extends Shape {
    ...
    render() {
        ...
        <svg version="1.1"
            width="300" height="200"
            xmlns="http://www.w3.org/2000/svg">
            <rect width="200" height="200" fill="${this.shapeColourChoice}"/>
            <text x="100" y="125" font-size="70" text-anchor="middle" fill="${this.textColourChoice}">${this.text}</text>
        </svg>
        `
    };
};
